...
public class InitTennisData {
    ...
    //Descomentar la carga de datos que se quiera probar
        cargarDatos2(campeonato);//Produce la salida Salida1_EC1
    ...
    private void cargarDatos1(Campeonato campeonato) {
        //Instanciamos 8 zapatillas: (Los parámetros están en el orden: modelo, número, tipo valor)
         ...
         Zapatilla z3= new Zapatilla ("Gel-Resolution 8 GS", 41, "agarre", 4);
         Zapatilla z4= new Zapatilla ("Vapor Lite", 41, "amortiguacion", 3);
         Zapatilla z5= new Zapatilla ("Court Lite", 41, "agarre", 3);
         Zapatilla z6= new Zapatilla ("UberSonic 4K", 41, "amortiguacion", 5.5);
         Zapatilla z7= new Zapatilla ("Zoom GP Turbo", 41, "amortiguacion", 6);
         Zapatilla z8= new Zapatilla ("CourtJam Bounce", 41, "agarre", 3.5);
