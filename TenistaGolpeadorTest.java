...
/**
 * The test class TenistaGolpeadorTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class TenistaGolpeadorTest
{
    ...
    /**
     * Default constructor for test class TenistaGolpeadorTest
     */
    public TenistaGolpeadorTest()
    {
    }
    ...
    public void setUp()
    {
        ...
        this.tenista1 = new TenistaGolpeador("Novak Djokovic", zapatill1, 90, 80, 1, "Serbia", 41);
    ...
    public void golpearTest(){
        tenista1.golpear();
        assertEquals(0.24, tenista1.getPuntosAcumulados(),0.1);
    }
    ...
    public void jugarTest(){
        ...
        assertEquals(46657.2, tenista1.getPuntosAcumulados(), 0.1);
